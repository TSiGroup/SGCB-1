...
<div id="container" class="row-fluid">
    ...
    <tbody>
        ...
        <tr>
            <td>uno</td>
            <td>dos</td>
            <td style="width:100px;"><input name="CheckHerramienta" type="checkbox" /></td>
        </tr>
        ...
        <tr>
            <td>uno</td>
            <td>dos</td>
            <td style="width:100px;"><input id="checked" name="checked" type="checkbox" /></td>
        </tr>
        ...
        <tr>
            <td>uno</td>
            <td>dos</td>
            <td style="width:100px;"><input  id="checked" name="checked" type="checkbox" value="100" /></td>
        </tr>
