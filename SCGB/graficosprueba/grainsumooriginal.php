...
$res = $cn->Consulta("SELECT p.CODIGOPRODUCTO,p.P_NOMBRE,s.S_CANTIDAD CANTIDAD FROM INSUMO i,PRODUCTO p,STOCK s WHERE p.CODIGOPRODUCTO=i.CODIGOPRODUCTO and p.CODIGOPRODUCTO=s.CODIGOPRODUCTO and p.P_ESTADO=1
");
